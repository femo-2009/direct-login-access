...
create policy "Admins with permission manage categories"
...
create policy "Admins with permission delete any post"
  on public.posts for delete
  using (public.has_admin_permission(auth.uid(), 'can_delete_posts'));
...
create policy "Admins view reports"
  ...
  using (public.has_admin_permission(auth.uid(), 'can_review_reports'));
...
create policy "Admins grant verified badges"
...
create policy "Admins remove badges"
...
-- =========================================================
-- AUTO NOTIFICATION ON NEW POST (to followers)
-- =========================================================
